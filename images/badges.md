...
**s**⁠![asdasdf](http://localhost:3000/get-artifact?roomId=github.com/Legit-Control/markdown-playground/blob/main/images/badges.md&path=asd)⁠![ad](https://github.com/jwt/ruby-jwt/actions/workflows/test.yml/badge.svg?branch=main)[s](https://github.com/jwt/ruby-jwt/actions2w)

&#8203;

## Badges as plain Markdown

Basci[ badge](https://asd)s are scaling in the [same](https://tests.de) size like they are provided by the link
